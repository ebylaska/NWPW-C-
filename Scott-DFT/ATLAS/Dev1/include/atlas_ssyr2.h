...
#define ATL_s2CacheElts 4915
#define ATL_s2MU 16
#define ATL_s2NU 4
#define ATL_R1OC ATL_sgerk_L1b
#define ATL_R1OCr ATL_sgerk_L1b
#define ATL_R1IC ATL_sgerk_L1
#define ATL_R1ICr ATL_sgerk_L1

#define ATL_GetPartS2(A_, lda_, mb_, nb_) { (mb_) = 480; (nb_) = ATL_s2NU; }
