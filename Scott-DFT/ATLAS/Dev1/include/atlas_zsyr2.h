...
#define ATL_s2CacheElts 3072
#define ATL_s2MU 16
#define ATL_s2NU 1
#define ATL_R1OC ATL_zgerk_L0
#define ATL_R1OCr ATL_zgerk_L0
#define ATL_R1IC ATL_zgerk_L2
#define ATL_R1ICr ATL_zgerk_L2

#define ATL_GetPartS2(A_, lda_, mb_, nb_) { (mb_) = 752; (nb_) = ATL_s2NU; }
