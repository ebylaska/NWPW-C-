...
#endif
#endif
static void ATL_cJIK0x0x44TN1x1x44_aX_bX
 ...
 */
{
   ...
   #define incAk 88
   const int incAm = ((((lda) - 44) << 1)), incAn = -(((Mb*lda) << 1));
   #define incBk 88
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x44TN4x1x44_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   const float BetaAlpha = beta / alpha;
   #define incAk 88
   const int incAm = ((((((lda) << 2)) - 44) << 1)), incAn = -(((Mb*lda) << 1));
   #define incBk 88
   const int incBm = -88, incBn = (((ldb) << 1));
   #define incCm 8
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x44TN1x1x44_aX_bX(k, N, 44, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x44TN1x2x44_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x44TN1x1x44_aX_bX(M, k, 44, alpha, ca, lda, cb + (((Nb*ldb) << 1)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x44TN0x0x0_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x44TN4x1x44_aX_bX(M, k, 44, alpha, ca, lda, cb + (((Nb*ldb) << 1)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x44TN1x2x44_aX_bX(k, Nb, 44, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
