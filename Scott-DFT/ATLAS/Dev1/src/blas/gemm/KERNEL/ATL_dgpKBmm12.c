...
#endif
#endif
static void ATL_dJIK0x0x12TN1x1x12_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x12TN2x1x12_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 * lda=12, ldb=12, ldc=0, mu=2, nu=1, ku=12, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (((Nb) << 3)+((Nb) << 2));
   #define incAk 12
   const int incAm = 12, incAn = -(((Mb) << 3)+((Mb) << 2));
   #define incBk 12
   const int incBm = -12, incBn = 12;
   const int incAk0 = ((incAk) / 12), incBk0 = ((incBk) / 12);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x12TN1x1x12_a1_bX(k, N, 12, alpha, ca + (((Mb) << 3)+((Mb) << 2)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x12TN1x2x12_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 * lda=12, ldb=12, ldc=0, mu=1, nu=2, ku=12, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x12TN1x1x12_a1_bX(M, k, 12, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 2)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x12TN12x12x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 * lda=12, ldb=12, ldc=0, mu=2, nu=2, ku=12, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x12TN2x1x12_a1_bX(M, k, 12, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 2)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x12TN1x2x12_a1_bX(k, Nb, 12, alpha, ca + (((Mb) << 3)+((Mb) << 2)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
