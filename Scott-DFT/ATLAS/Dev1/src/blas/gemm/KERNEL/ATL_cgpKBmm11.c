 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x11TN4x1x11_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=11, 
 * lda=11, ldb=11, ldc=0, mu=4, nu=1, ku=11, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const float *stN = B + (11*(Nb));
   #define incAk 11
   const int incAm = 33, incAn = -(11*(Mb));
   #define incBk 11
   const int incBm = -11, incBn = 11;
   #define incCm 8
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
...
#endif
#endif
static void ATL_cJIK0x0x11TN1x2x11_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=11, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x11TN1x1x11_a1_bX(M, k, 11, alpha, ca, lda, cb + (11*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=11, 
 * lda=11, ldb=11, ldc=0, mu=4, nu=2, ku=11, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x11TN4x1x11_a1_bX(M, k, 11, alpha, ca, lda, cb + (11*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x11TN1x2x11_a1_bX(k, Nb, 11, alpha, ca + (11*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
