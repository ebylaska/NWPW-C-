...
#endif
#endif
static void ATL_dJIK0x0x9TN1x1x9_a1_bX
 ...
 */
{
   ...
   const int incAk0 = ((incAk) / 9), incBk0 = ((incBk) / 9);
   #define incCm 1
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x9TN2x1x9_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=9, 
 * lda=9, ldb=9, ldc=0, mu=2, nu=1, ku=9, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (((Nb) << 3)+Nb);
   #define incAk 9
   const int incAm = 9, incAn = -(((Mb) << 3)+Mb);
   #define incBk 9
   const int incBm = -9, incBn = 9;
   const int incAk0 = ((incAk) / 9), incBk0 = ((incBk) / 9);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x9TN1x1x9_a1_bX(k, N, 9, alpha, ca + (((Mb) << 3)+Mb), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x9TN1x2x9_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=9, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x9TN1x1x9_a1_bX(M, k, 9, alpha, ca, lda, cb + (((Nb) << 3)+Nb), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x9TN9x9x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=9, 
 * lda=9, ldb=9, ldc=0, mu=2, nu=2, ku=9, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x9TN2x1x9_a1_bX(M, k, 9, alpha, ca, lda, cb + (((Nb) << 3)+Nb), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x9TN1x2x9_a1_bX(k, Nb, 9, alpha, ca + (((Mb) << 3)+Mb), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
