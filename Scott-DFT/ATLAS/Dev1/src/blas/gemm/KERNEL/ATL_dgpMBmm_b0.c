#ifdef ATL_UCLEANM
#define ATL_dJIK0x48x48TN48x48x0_a1_b0 ATL_dgpMBmm_b0
#else
#define ATL_dJIK0x48x48TN48x48x0_a1_b0 ATL_dpMBmm_b0
#endif
...
#endif
#endif
static void ATL_dJIK0x48x48TN1x2x48_a1_b0
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=48, KB=48, 
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_dJIK0x48x48TN48x48x0_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=48, KB=48, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_dJIK0x48x48TN1x2x48_a1_b0(k, 48, 48, alpha, ca + (((Mb) << 5)+((Mb) << 4)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
