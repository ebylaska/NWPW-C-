...
#endif
#endif
static void ATL_zJIK52x0x52TN4x1x52_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_zJIK52x0x52TN52x52x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=52, NB=0, KB=52, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_zJIK52x0x52TN4x1x52_a1_bX(52, k, 52, alpha, ca, lda, cb + (52*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#ifdef ATL_UCLEANN
#define ATL_zpNBmm_bX ATL_zgpNBmm_bX
#endif
...
void ATL_zpNBmm_bX(const int M, const int N, const int K, const double alpha, const double *A, const int lda, const double *B, const int ldb, const double beta, double *C, const int ldc)
{
