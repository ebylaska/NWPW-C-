...
#endif
#endif
static void ATL_dJIK0x0x15TN1x1x15_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x15TN2x1x15_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=15, 
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x15TN1x1x15_a1_bX(k, N, 15, alpha, ca + (15*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x15TN1x2x15_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=15, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x15TN1x1x15_a1_bX(M, k, 15, alpha, ca, lda, cb + (15*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x15TN15x15x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=15, 
 * lda=15, ldb=15, ldc=0, mu=2, nu=2, ku=15, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x15TN2x1x15_a1_bX(M, k, 15, alpha, ca, lda, cb + (15*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x15TN1x2x15_a1_bX(k, Nb, 15, alpha, ca + (15*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
