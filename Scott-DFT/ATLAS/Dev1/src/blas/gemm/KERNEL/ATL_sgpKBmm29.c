 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x29TN4x1x29_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
...
#endif
#endif
static void ATL_sJIK0x0x29TN1x2x29_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x29TN1x1x29_a1_bX(M, k, 29, alpha, ca, lda, cb + (29*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x29TN4x1x29_a1_bX(M, k, 29, alpha, ca, lda, cb + (29*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x29TN1x2x29_a1_bX(k, Nb, 29, alpha, ca + (29*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
