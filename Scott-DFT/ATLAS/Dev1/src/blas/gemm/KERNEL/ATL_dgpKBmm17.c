...
#endif
#endif
static void ATL_dJIK0x0x17TN1x1x17_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x17TN2x1x17_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=17, 
 * lda=17, ldb=17, ldc=0, mu=2, nu=1, ku=17, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (((Nb) << 4)+Nb);
   #define incAk 17
   const int incAm = 17, incAn = -(((Mb) << 4)+Mb);
   #define incBk 17
   const int incBm = -17, incBn = 17;
   const int incAk0 = ((incAk) / 17), incBk0 = ((incBk) / 17);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x17TN1x1x17_a1_bX(k, N, 17, alpha, ca + (((Mb) << 4)+Mb), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x17TN1x2x17_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=17, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x17TN1x1x17_a1_bX(M, k, 17, alpha, ca, lda, cb + (((Nb) << 4)+Nb), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=17, 
 * lda=17, ldb=17, ldc=0, mu=2, nu=2, ku=17, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x17TN2x1x17_a1_bX(M, k, 17, alpha, ca, lda, cb + (((Nb) << 4)+Nb), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x17TN1x2x17_a1_bX(k, Nb, 17, alpha, ca + (((Mb) << 4)+Mb), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
