...
#endif
#endif
static void ATL_dJIK0x0x36TN1x1x36_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x36TN2x1x36_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 * lda=36, ldb=36, ldc=0, mu=2, nu=1, ku=36, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (((Nb) << 5)+((Nb) << 2));
   #define incAk 36
   const int incAm = 36, incAn = -(((Mb) << 5)+((Mb) << 2));
   #define incBk 36
   const int incBm = -36, incBn = 36;
   const int incAk0 = ((incAk) / 36), incBk0 = ((incBk) / 36);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x36TN1x1x36_a1_bX(k, N, 36, alpha, ca + (((Mb) << 5)+((Mb) << 2)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x36TN1x2x36_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x36TN1x1x36_a1_bX(M, k, 36, alpha, ca, lda, cb + (((Nb) << 5)+((Nb) << 2)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=36, 
 * lda=36, ldb=36, ldc=0, mu=2, nu=2, ku=36, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x36TN2x1x36_a1_bX(M, k, 36, alpha, ca, lda, cb + (((Nb) << 5)+((Nb) << 2)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x36TN1x2x36_a1_bX(k, Nb, 36, alpha, ca + (((Mb) << 5)+((Mb) << 2)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
