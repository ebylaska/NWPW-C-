...
#endif
#endif
static void ATL_cJIK0x0x22TN1x1x22_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x22TN4x1x22_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x22TN1x1x22_a1_bX(k, N, 22, alpha, ca + (22*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x22TN1x2x22_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x22TN1x1x22_a1_bX(M, k, 22, alpha, ca, lda, cb + (22*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x22TN22x22x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x22TN4x1x22_a1_bX(M, k, 22, alpha, ca, lda, cb + (22*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x22TN1x2x22_a1_bX(k, Nb, 22, alpha, ca + (22*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
