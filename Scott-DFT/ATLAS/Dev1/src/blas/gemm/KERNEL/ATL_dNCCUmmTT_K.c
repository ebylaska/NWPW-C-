...
#endif
#endif
static void ATL_dJIK0x0x48TT1x1x48_aX_bX
...
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=48, 
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x48TT2x1x48_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=48, 
 * lda=0, ldb=0, ldc=0, mu=2, nu=1, ku=48, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x48TT1x1x48_aX_bX(k, N, 48, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x48TT1x2x48_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=48, 
 * lda=0, ldb=0, ldc=0, mu=1, nu=2, ku=48, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x48TT1x1x48_aX_bX(M, k, 48, alpha, ca, lda, cb + (Nb), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x48TT0x0x0_aX_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=48, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x48TT2x1x48_aX_bX(M, k, 48, alpha, ca, lda, cb + (Nb), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x48TT1x2x48_aX_bX(k, Nb, 48, alpha, ca + (Mb*lda), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
