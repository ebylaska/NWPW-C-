...
#endif
#endif
static void ATL_cJIK0x0x58TN1x1x58_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x58TN4x1x58_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=58, 
 * lda=58, ldb=58, ldc=0, mu=4, nu=1, ku=58, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const float *stN = B + (58*(Nb));
   #define incAk 58
   const int incAm = 174, incAn = -(58*(Mb));
   #define incBk 58
   const int incBm = -58, incBn = 58;
   #define incCm 8
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x58TN1x1x58_a1_bX(k, N, 58, alpha, ca + (58*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x58TN1x2x58_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=58, 
 * lda=58, ldb=58, ldc=0, mu=1, nu=2, ku=58, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   #define Mb M
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x58TN1x1x58_a1_bX(M, k, 58, alpha, ca, lda, cb + (58*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=58, 
 * lda=58, ldb=58, ldc=0, mu=4, nu=2, ku=58, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x58TN4x1x58_a1_bX(M, k, 58, alpha, ca, lda, cb + (58*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x58TN1x2x58_a1_bX(k, Nb, 58, alpha, ca + (58*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
