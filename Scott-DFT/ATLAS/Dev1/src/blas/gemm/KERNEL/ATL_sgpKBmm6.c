 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x6TN4x1x6_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=6, 
 * lda=6, ldb=6, ldc=0, mu=4, nu=1, ku=6, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const float *stN = B + (((Nb) << 2)+((Nb) << 1));
   #define incAk 6
   const int incAm = 18, incAn = -(((Mb) << 2)+((Mb) << 1));
   #define incBk 6
   const int incBm = -6, incBn = 6;
   #define incCm 4
   const int incCn = (ldc) - (Mb);
...
#endif
#endif
static void ATL_sJIK0x0x6TN1x2x6_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=6, 
 * lda=6, ldb=6, ldc=0, mu=1, nu=2, ku=6, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   #define Mb M
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x6TN1x1x6_a1_bX(M, k, 6, alpha, ca, lda, cb + (((Nb) << 2)+((Nb) << 1)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=6, 
 * lda=6, ldb=6, ldc=0, mu=4, nu=2, ku=6, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x6TN4x1x6_a1_bX(M, k, 6, alpha, ca, lda, cb + (((Nb) << 2)+((Nb) << 1)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x6TN1x2x6_a1_bX(k, Nb, 6, alpha, ca + (((Mb) << 2)+((Mb) << 1)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
