...
#endif
#endif
static void ATL_dJIK0x0x22TN1x1x22_a1_bX
 ...
 */
{
   #define Mb M
   #define Nb N
   const double *stM = A + (22*(Mb));
   const double *stN = B + (22*(Nb));
   #define incAk 22
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x22TN2x1x22_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 * lda=22, ldb=22, ldc=0, mu=2, nu=1, ku=22, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (22*(Nb));
   #define incAk 22
   const int incAm = 22, incAn = -(22*(Mb));
   #define incBk 22
   const int incBm = -22, incBn = 22;
   const int incAk0 = ((incAk) / 22), incBk0 = ((incBk) / 22);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x22TN1x1x22_a1_bX(k, N, 22, alpha, ca + (22*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x22TN1x2x22_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x22TN1x1x22_a1_bX(M, k, 22, alpha, ca, lda, cb + (22*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x22TN22x22x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=22, 
 * lda=22, ldb=22, ldc=0, mu=2, nu=2, ku=22, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x22TN2x1x22_a1_bX(M, k, 22, alpha, ca, lda, cb + (22*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x22TN1x2x22_a1_bX(k, Nb, 22, alpha, ca + (22*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
