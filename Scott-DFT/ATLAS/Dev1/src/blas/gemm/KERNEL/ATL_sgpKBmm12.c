 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x12TN4x1x12_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
...
#endif
#endif
static void ATL_sJIK0x0x12TN1x2x12_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x12TN1x1x12_a1_bX(M, k, 12, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 2)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x12TN4x1x12_a1_bX(M, k, 12, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 2)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x12TN1x2x12_a1_bX(k, Nb, 12, alpha, ca + (((Mb) << 3)+((Mb) << 2)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
