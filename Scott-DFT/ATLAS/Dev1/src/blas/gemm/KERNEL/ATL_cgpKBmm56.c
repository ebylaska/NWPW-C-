...
#endif
#endif
static void ATL_cJIK0x0x56TN1x1x56_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x56TN4x1x56_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=56, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x56TN1x1x56_a1_bX(k, N, 56, alpha, ca + (56*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x56TN1x2x56_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=56, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x56TN1x1x56_a1_bX(M, k, 56, alpha, ca, lda, cb + (56*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x56TN4x1x56_a1_bX(M, k, 56, alpha, ca, lda, cb + (56*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x56TN1x2x56_a1_bX(k, Nb, 56, alpha, ca + (56*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
