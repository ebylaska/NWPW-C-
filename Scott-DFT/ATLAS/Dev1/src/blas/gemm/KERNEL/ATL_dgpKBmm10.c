...
#endif
#endif
static void ATL_dJIK0x0x10TN1x1x10_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x10TN2x1x10_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=10, 
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x10TN1x1x10_a1_bX(k, N, 10, alpha, ca + (((Mb) << 3)+((Mb) << 1)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x10TN1x2x10_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=10, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x10TN1x1x10_a1_bX(M, k, 10, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 1)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x10TN10x10x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=10, 
 * lda=10, ldb=10, ldc=0, mu=2, nu=2, ku=10, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x10TN2x1x10_a1_bX(M, k, 10, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 1)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x10TN1x2x10_a1_bX(k, Nb, 10, alpha, ca + (((Mb) << 3)+((Mb) << 1)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
