...
#endif
#endif
static void ATL_dJIK0x0x16TN1x1x16_a1_bX
 ...
 */
{
   #define Mb M
   #define Nb N
   const double *stM = A + (((Mb) << 4));
   const double *stN = B + (((Nb) << 4));
   #define incAk 16
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x16TN2x1x16_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 * lda=16, ldb=16, ldc=0, mu=2, nu=1, ku=16, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x16TN1x1x16_a1_bX(k, N, 16, alpha, ca + (((Mb) << 4)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x16TN1x2x16_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 * lda=16, ldb=16, ldc=0, mu=1, nu=2, ku=16, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x16TN1x1x16_a1_bX(M, k, 16, alpha, ca, lda, cb + (((Nb) << 4)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x16TN16x16x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 * lda=16, ldb=16, ldc=0, mu=2, nu=2, ku=16, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x16TN2x1x16_a1_bX(M, k, 16, alpha, ca, lda, cb + (((Nb) << 4)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x16TN1x2x16_a1_bX(k, Nb, 16, alpha, ca + (((Mb) << 4)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
