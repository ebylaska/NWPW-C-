#define ATL_USERMM ATL_zJIK52x52x52TN52x52x0_a1_bX
#define ATL_USERMM_b1 ATL_zJIK52x52x52TN52x52x0_a1_b1
#define ATL_USERMM_bn1 ATL_zJIK52x52x52TN52x52x0_a1_bn1
#define ATL_USERMM_b0 ATL_zJIK52x52x52TN52x52x0_a1_b0
#define ATL_USERMM_bX ATL_zJIK52x52x52TN52x52x0_a1_bX
#define BETAX
#define DCPLX
                 ...
                 const TYPE beta, TYPE *C, const ATL_INT ldc )
{
   ...
   for( j=-52; j!=0; j+=J_UNROLL) 
   {
      ...
      for( i=-52; i != 0; i+= I_UNROLL )
      {
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 192) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 194) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 196) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 198) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 200) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 202) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 204) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         B3 = _mm_load_pd( MMCAST(B0_off + 206) );
         A0 = _mm_mul_pd( B3, A0 );
         c3_0 = _mm_add_pd( A0, c3_0 );
         A1 = _mm_mul_pd( B3, A1 );
         c3_1 = _mm_add_pd( A1, c3_1 );
         ...
         _mm_store_sd( cPtrI3+0, c3_0 );
         temp = _mm_shuffle_pd( c3_0, c3_0,_MM_SHUFFLE2(1,1));
         _mm_store_sd( cPtrI3+2, temp );
   ...
   for( j=-52; j!=0; j+=J_UNROLL) 
   {
      ...
      for( i=-52; i != 0; i+= I_UNROLL )
      {
         ...
         /* Applying Beta */
            ...
            /* Load C from memory */
            temp0 = _mm_load_sd( cPtrI3 + 0 );
            temp1 = _mm_load_sd( cPtrI3 + 2 );
            bc3_0 = _mm_shuffle_pd( temp0, temp1,_MM_SHUFFLE2(0, 0 )  );
