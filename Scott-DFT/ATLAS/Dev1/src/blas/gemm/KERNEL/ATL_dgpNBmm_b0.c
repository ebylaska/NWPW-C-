#ifdef ATL_UCLEANN
#define ATL_dJIK48x0x48TN48x48x0_a1_b0 ATL_dgpNBmm_b0
#else
#define ATL_dJIK48x0x48TN48x48x0_a1_b0 ATL_dpNBmm_b0
#endif
...
#endif
#endif
static void ATL_dJIK48x0x48TN4x1x48_a1_b0
 ...
 */
{
   ...
   #undef Kb
#endif
void ATL_dJIK48x0x48TN48x48x0_a1_b0
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=48, NB=0, KB=48, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_dJIK48x0x48TN4x1x48_a1_b0(48, k, 48, alpha, ca, lda, cb + (((Nb) << 5)+((Nb) << 4)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
