...
#endif
#endif
static void ATL_cJIK0x0x12TN1x1x12_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x12TN4x1x12_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 * lda=12, ldb=12, ldc=0, mu=4, nu=1, ku=12, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const float *stN = B + (((Nb) << 3)+((Nb) << 2));
   #define incAk 12
   const int incAm = 36, incAn = -(((Mb) << 3)+((Mb) << 2));
   #define incBk 12
   const int incBm = -12, incBn = 12;
   #define incCm 8
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x12TN1x1x12_a1_bX(k, N, 12, alpha, ca + (((Mb) << 3)+((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x12TN1x2x12_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x12TN1x1x12_a1_bX(M, k, 12, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 2)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=12, 
 * lda=12, ldb=12, ldc=0, mu=4, nu=2, ku=12, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x12TN4x1x12_a1_bX(M, k, 12, alpha, ca, lda, cb + (((Nb) << 3)+((Nb) << 2)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x12TN1x2x12_a1_bX(k, Nb, 12, alpha, ca + (((Mb) << 3)+((Mb) << 2)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
