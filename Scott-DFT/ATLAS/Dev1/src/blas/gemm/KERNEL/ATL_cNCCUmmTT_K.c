...
#endif
#endif
static void ATL_cJIK0x0x44TT1x1x44_aX_bX
...
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x44TT4x1x44_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x44TT1x1x44_aX_bX(k, N, 44, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x44TT1x2x44_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x44TT1x1x44_aX_bX(M, k, 44, alpha, ca, lda, cb + (((Nb) << 1)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x44TT0x0x0_aX_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=T, MB=0, NB=0, KB=44, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x44TT4x1x44_aX_bX(M, k, 44, alpha, ca, lda, cb + (((Nb) << 1)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x44TT1x2x44_aX_bX(k, Nb, 44, alpha, ca + (((Mb*lda) << 1)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
