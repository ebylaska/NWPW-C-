...
#endif
#endif
static void ATL_dJIK0x0x29TN1x1x29_a1_bX
 ...
 */
{
   #define Mb M
   #define Nb N
   const double *stM = A + (29*(Mb));
   const double *stN = B + (29*(Nb));
   #define incAk 29
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x29TN2x1x29_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 * lda=29, ldb=29, ldc=0, mu=2, nu=1, ku=29, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (29*(Nb));
   #define incAk 29
   const int incAm = 29, incAn = -(29*(Mb));
   #define incBk 29
   const int incBm = -29, incBn = 29;
   const int incAk0 = ((incAk) / 29), incBk0 = ((incBk) / 29);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x29TN1x1x29_a1_bX(k, N, 29, alpha, ca + (29*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x29TN1x2x29_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 * lda=29, ldb=29, ldc=0, mu=1, nu=2, ku=29, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   #define Mb M
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x29TN1x1x29_a1_bX(M, k, 29, alpha, ca, lda, cb + (29*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_dJIK0x0x29TN29x29x0_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 * lda=29, ldb=29, ldc=0, mu=2, nu=2, ku=29, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x29TN2x1x29_a1_bX(M, k, 29, alpha, ca, lda, cb + (29*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x29TN1x2x29_a1_bX(k, Nb, 29, alpha, ca + (29*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
