...
#endif
#endif
static void ATL_sJIK0x0x52TN1x1x52_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x52TN4x1x52_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_sJIK0x0x52TN1x1x52_a1_bX(k, N, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_sJIK0x0x52TN1x2x52_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x52TN1x1x52_a1_bX(M, k, 52, alpha, ca, lda, cb + (52*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_sJIK0x0x52TN52x52x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=52, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x52TN4x1x52_a1_bX(M, k, 52, alpha, ca, lda, cb + (52*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x52TN1x2x52_a1_bX(k, Nb, 52, alpha, ca + (52*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
