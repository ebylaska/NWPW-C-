...
#endif
#endif
static void ATL_cJIK0x0x29TN1x1x29_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x29TN4x1x29_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 * lda=29, ldb=29, ldc=0, mu=4, nu=1, ku=29, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const float *stN = B + (29*(Nb));
   #define incAk 29
   const int incAm = 87, incAn = -(29*(Mb));
   #define incBk 29
   const int incBm = -29, incBn = 29;
   #define incCm 8
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x29TN1x1x29_a1_bX(k, N, 29, alpha, ca + (29*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x29TN1x2x29_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x29TN1x1x29_a1_bX(M, k, 29, alpha, ca, lda, cb + (29*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=29, 
 * lda=29, ldb=29, ldc=0, mu=4, nu=2, ku=29, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x29TN4x1x29_a1_bX(M, k, 29, alpha, ca, lda, cb + (29*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x29TN1x2x29_a1_bX(k, Nb, 29, alpha, ca + (29*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
