#define ATL_USERMM ATL_sJIK72x72x72TN72x72x0_a1_b1
#define ATL_USERMM_b1 ATL_sJIK72x72x72TN72x72x0_a1_b1
#define ATL_USERMM_bn1 ATL_sJIK72x72x72TN72x72x0_a1_bn1
#define ATL_USERMM_b0 ATL_sJIK72x72x72TN72x72x0_a1_b0
#define ATL_USERMM_bX ATL_sJIK72x72x72TN72x72x0_a1_bX
#define BETA1
#define SREAL
                 ...
                 const TYPE beta, TYPE *C, const ATL_INT ldc )
{
   ...
   const ATL_INT pfBlockDistance = (4 * 3 * KB * 4) / 72;
   /* =======================================
   ...
   for( j=-72; j!=0; j+=J_UNROLL) 
   {
      ...
      for( i=-72; i != 0; i+= I_UNROLL )
      {
         ...
         _mm_storeu_ps( MMCAST( cPtrI0 ),  MMCASTintrin( c0_0 ) );
         _mm_storeu_ps( MMCAST( cPtrI1 ),  MMCASTintrin( c1_0 ) );
         _mm_storeu_ps( MMCAST( cPtrI2 ),  MMCASTintrin( c2_0 ) );
         cPtrI0 += I_UNROLL;
         cPtrI1 += I_UNROLL;
         cPtrI2 += I_UNROLL;
