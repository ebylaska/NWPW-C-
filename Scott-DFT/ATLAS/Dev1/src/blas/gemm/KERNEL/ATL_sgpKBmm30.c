...
#endif
#endif
static void ATL_sJIK0x0x30TN1x1x30_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_sJIK0x0x30TN4x1x30_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=30, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_sJIK0x0x30TN1x1x30_a1_bX(k, N, 30, alpha, ca + (30*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_sJIK0x0x30TN1x2x30_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=30, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x30TN1x1x30_a1_bX(M, k, 30, alpha, ca, lda, cb + (30*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_sJIK0x0x30TN30x30x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=30, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_sJIK0x0x30TN4x1x30_a1_bX(M, k, 30, alpha, ca, lda, cb + (30*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_sJIK0x0x30TN1x2x30_a1_bX(k, Nb, 30, alpha, ca + (30*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
