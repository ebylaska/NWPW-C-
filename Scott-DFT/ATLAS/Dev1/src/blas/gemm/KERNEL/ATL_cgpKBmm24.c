...
#endif
#endif
static void ATL_cJIK0x0x24TN1x1x24_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x24TN4x1x24_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=24, 
 ...
 */
{
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x24TN1x1x24_a1_bX(k, N, 24, alpha, ca + (((Mb) << 4)+((Mb) << 3)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x24TN1x2x24_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=24, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x24TN1x1x24_a1_bX(M, k, 24, alpha, ca, lda, cb + (((Nb) << 4)+((Nb) << 3)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x24TN4x1x24_a1_bX(M, k, 24, alpha, ca, lda, cb + (((Nb) << 4)+((Nb) << 3)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x24TN1x2x24_a1_bX(k, Nb, 24, alpha, ca + (((Mb) << 4)+((Mb) << 3)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
