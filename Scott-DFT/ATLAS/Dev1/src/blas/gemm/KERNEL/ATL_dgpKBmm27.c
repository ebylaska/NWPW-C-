...
#endif
#endif
static void ATL_dJIK0x0x27TN1x1x27_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x27TN2x1x27_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=27, 
 * lda=27, ldb=27, ldc=0, mu=2, nu=1, ku=27, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (27*(Nb));
   #define incAk 27
   const int incAm = 27, incAn = -(27*(Mb));
   #define incBk 27
   const int incBm = -27, incBn = 27;
   const int incAk0 = ((incAk) / 27), incBk0 = ((incBk) / 27);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x27TN1x1x27_a1_bX(k, N, 27, alpha, ca + (27*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x27TN1x2x27_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=27, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x27TN1x1x27_a1_bX(M, k, 27, alpha, ca, lda, cb + (27*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=27, 
 * lda=27, ldb=27, ldc=0, mu=2, nu=2, ku=27, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x27TN2x1x27_a1_bX(M, k, 27, alpha, ca, lda, cb + (27*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x27TN1x2x27_a1_bX(k, Nb, 27, alpha, ca + (27*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
