...
#endif
#endif
static void ATL_cJIK0x0x16TN1x1x16_a1_bX
 ...
 */
{
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x16TN4x1x16_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 * lda=16, ldb=16, ldc=0, mu=4, nu=1, ku=16, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x16TN1x1x16_a1_bX(k, N, 16, alpha, ca + (((Mb) << 4)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x16TN1x2x16_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x16TN1x1x16_a1_bX(M, k, 16, alpha, ca, lda, cb + (((Nb) << 4)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=16, 
 * lda=16, ldb=16, ldc=0, mu=4, nu=2, ku=16, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x16TN4x1x16_a1_bX(M, k, 16, alpha, ca, lda, cb + (((Nb) << 4)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x16TN1x2x16_a1_bX(k, Nb, 16, alpha, ca + (((Mb) << 4)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
