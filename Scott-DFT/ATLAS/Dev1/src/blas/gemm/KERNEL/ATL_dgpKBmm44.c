...
#endif
#endif
static void ATL_dJIK0x0x44TN1x1x44_a1_bX
 ...
 */
   ...
   #undef Kb
#endif
static void ATL_dJIK0x0x44TN2x1x44_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=44, 
 * lda=44, ldb=44, ldc=0, mu=2, nu=1, ku=44, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
   ...
   const double *stN = B + (44*(Nb));
   #define incAk 44
   const int incAm = 44, incAn = -(44*(Mb));
   #define incBk 44
   const int incBm = -44, incBn = 44;
   const int incAk0 = ((incAk) / 44), incBk0 = ((incBk) / 44);
   #define incCm 2
 ...
 */
   ...
   if (k=M-Mb)
      ATL_dJIK0x0x44TN1x1x44_a1_bX(k, N, 44, alpha, ca + (44*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_dJIK0x0x44TN1x2x44_a1_bX
   (const int M, const int N, const int K, const double alpha, const double * ATL_RESTRICT A, const int lda, const double * ATL_RESTRICT B, const int ldb, const double beta, double * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=44, 
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x44TN1x1x44_a1_bX(M, k, 44, alpha, ca, lda, cb + (44*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=44, 
 * lda=44, ldb=44, ldc=0, mu=2, nu=2, ku=44, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>1)<<1;
 ...
 */
   ...
   if (k=N-Nb)
      ATL_dJIK0x0x44TN2x1x44_a1_bX(M, k, 44, alpha, ca, lda, cb + (44*(Nb)), ldb, beta, cc + (Nb*ldc), ldc);
   if (Nb && (k=M-Mb))
      ATL_dJIK0x0x44TN1x2x44_a1_bX(k, Nb, 44, alpha, ca + (44*(Mb)), lda, cb, ldb, beta, cc + (Mb), ldc);
}
#ifdef incAm
   #undef incAm
#endif
