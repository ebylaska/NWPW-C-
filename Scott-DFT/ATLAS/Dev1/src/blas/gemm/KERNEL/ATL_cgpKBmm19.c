...
#endif
#endif
static void ATL_cJIK0x0x19TN1x1x19_a1_bX
 ...
 */
{
   #define Mb M
   #define Nb N
   const float *stM = A + (19*(Mb));
   const float *stN = B + (19*(Nb));
   #define incAk 19
   ...
   #undef Kb
#endif
static void ATL_cJIK0x0x19TN4x1x19_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=19, 
 * lda=19, ldb=19, ldc=0, mu=4, nu=1, ku=19, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   const float *stN = B + (19*(Nb));
   #define incAk 19
   const int incAm = 57, incAn = -(19*(Mb));
   #define incBk 19
   const int incBm = -19, incBn = 19;
   #define incCm 8
   const int incCn = (((ldc) << 1)) - (((Mb) << 1));
   ...
   if (k=M-Mb)
      ATL_cJIK0x0x19TN1x1x19_a1_bX(k, N, 19, alpha, ca + (19*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
...
#endif
#endif
static void ATL_cJIK0x0x19TN1x2x19_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=19, 
 ...
 */
{
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x19TN1x1x19_a1_bX(M, k, 19, alpha, ca, lda, cb + (19*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
   ...
   #undef Kb
#endif
void ATL_cJIK0x0x19TN19x19x0_a1_bX
   (const int M, const int N, const int K, const float alpha, const float * ATL_RESTRICT A, const int lda, const float * ATL_RESTRICT B, const int ldb, const float beta, float * ATL_RESTRICT C, const int ldc)
/*
 * matmul with TA=T, TB=N, MB=0, NB=0, KB=19, 
 * lda=19, ldb=19, ldc=0, mu=4, nu=2, ku=19, pf=0
 * Generated by ATLAS/tune/blas/gemm/emit_mm.c (3.9.23)
 */
{
   const int Mb = (M>>2)<<2;
   ...
   if (k=N-Nb)
      ATL_cJIK0x0x19TN4x1x19_a1_bX(M, k, 19, alpha, ca, lda, cb + (19*(Nb)), ldb, beta, cc + (((Nb*ldc) << 1)), ldc);
   if (Nb && (k=M-Mb))
      ATL_cJIK0x0x19TN1x2x19_a1_bX(k, Nb, 19, alpha, ca + (19*(Mb)), lda, cb, ldb, beta, cc + (((Mb) << 1)), ldc);
}
#ifdef incAm
   #undef incAm
#endif
