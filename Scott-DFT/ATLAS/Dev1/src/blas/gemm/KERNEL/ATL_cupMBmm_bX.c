...
#define ATL_CupMBmm0_2_0_bX(M_, N_, K_, al_, A_, lda_, B_, ldb_, be_, C_, ldc_) \
{ \
   ATL_cupMBmm0_2_0_bX(M_, N_, K_, al_, A_, lda_, B_, ldb_, -(be_), C_, ldc_); \
   ATL_cupMBmm0_2_0_bX(M_, N_, K_, al_, A_, lda_, (B_)+(ldb_)*(N_), ldb_, be_, (C_)+1, ldc_); \
    ...
    const float beta, float *C, const int ldc)
{
   ...
   else ATL_cgpMBmm_bX(M, N, K, alpha, A, lda, B, ldb, beta, C, ldc);
}
