...
static int64_t bo_steps[2],bo_algorithm;
static int64_t loop[2],ngrid[3],npsp,ncut,mapping,mapping1d;
static int64_t np_dimensions[3],ewald_grid[3];
static int64_t code,gga;
static int64_t ispin,multiplicity;
static int64_t move,frac_coord,SA,fei,fei_quench,gram_schmidt;
static int64_t rotation,translation,balance,spin_orbit;
static int64_t maxit_orb,maxit_orbs,scf_algorithm,ks_algorithm;
static int64_t symm_number;
