...
class Strfac
{
 ...
 public:
   ...
   *                               *
   *********************************/
  inline void strfac_exi(const int ii, Real *ss) {
    cerr << "---------- strfac_exi (Real *) -----------" << endl;
    strfac_sub(nfft3d,
	       &wx1[2*ii*cd->nx],
	       &wy1[2*ii*cd->ny],
	       &wz1[2*ii*cd->nz],
  ...
  inline void strfac_exi(const int ii, thrust::host_vector<Real2> &ss) {
  ...
  inline void strfac_exi(const int ii, thrust::device_vector<Real2> &ss) {
